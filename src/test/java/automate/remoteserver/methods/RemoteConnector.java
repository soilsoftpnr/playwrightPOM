...
public static Session session;
    ...
    public static void softwareUpdateInRemoteServer(String host, String username, String password, int port) {
        try {
            ...
            // You can add similar commands for other package managers or specific update procedures
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    // Other methods for remote operations (e.g., executeCommand, executeScript, etc.) can be added here
}
